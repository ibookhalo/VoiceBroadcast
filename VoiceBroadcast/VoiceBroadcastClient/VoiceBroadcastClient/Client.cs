...
namespace VoiceBroadcastClient
{
    public class TCPClient
    {
        ...
        public delegate void DelegateDataReceived(VoiceBroadcastClient.TCPClient client, Byte[] bytes);
        public delegate void DelegateDataSend(VoiceBroadcastClient.TCPClient client, Byte[] bytes);
        public delegate void DelegateDataReceivedComplete(VoiceBroadcastClient.TCPClient client, String message);
        public delegate void DelegateConnection(VoiceBroadcastClient.TCPClient client, string Info);
        public delegate void DelegateException(VoiceBroadcastClient.TCPClient client, Exception ex);
        ...
        /// </summary>
        /// <param name="ex"></param>
        private void OnExceptionAppeared(VoiceBroadcastClient.TCPClient client, Exception ex)
        {
        ...
        private void OnConnected(VoiceBroadcastClient.TCPClient client, string info)
        {
        ...
        /// </summary>
        /// <param name="client"></param>
        private void OnDisconnected(VoiceBroadcastClient.TCPClient client, string info)
        {
